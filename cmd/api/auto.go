...
func (app *application) login(c *gin.Context) {
	...
	if existingUser == nil {
		c.JSON(http.StatusUnauthorized, gin.H{"error": "Invalid email or passwod"})
		return
	}
	if err != nil {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Errrr gentraint token"})
	}
	c.JSON(http.StatusOK, loginResponese{Token: tokenString})
}
